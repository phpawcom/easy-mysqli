...
class database {
	...
	public function is($operation = '=', $value){		
		...
		switch($operation){
			...
			case 'likeQ': $term = 'like \'%'.str_replace('&quot;', '"', $this->escape_string($value)).'%\' '; break;
			case 'fnEq': $term = '= '.$value.' '; break;
			case 'fnGt': $term = '> '.$this->escape_string($value).' '; break;
			case 'fnGtEq': $term = '>= '.$this->escape_string($value).' '; break;
			case 'fnLt': $term = '< '.$this->escape_string($value).' '; break;
			case 'fnLtEq': $term = '<= '.$this->escape_string($value).' '; break;
